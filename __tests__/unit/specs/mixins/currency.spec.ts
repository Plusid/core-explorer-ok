...
describe("Mixins > Currency", () => {
  ...
  describe("rawCurrency", () => {
    it("should display selected cryptocurrency with 5 digits or less", () => {
      ...
      expect(wrapper.vm.rawCurrency(10.1234567891234, "ARK")).toEqual(displayCrypto(10.12345));
      expect(wrapper.vm.rawCurrency(10.1234567891234, "ETH")).toEqual(displayCrypto(10.12345));
      expect(wrapper.vm.rawCurrency(10.1234567891234, "BTC")).toEqual(displayCrypto(10.12345));
