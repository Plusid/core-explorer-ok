...
describe("Mixins > Currency", () => {
  ...
  describe("readableCrypto", () => {
    ...
    it("should return crypto value in readable format, including symbol", () => {
      ...
      expect(wrapper.vm.readableCrypto(10.1234 * Math.pow(10, 5), true)).toEqual(displayCrypto(10.1234) + " Ѧ");
    });
  ...
  describe("readableCurrency", () => {
    ...
    it("should properly format the given data", () => {
      expect(wrapper.vm.readableCurrency(100000, null, "ARK")).toEqual("1 Ѧ");
      expect(wrapper.vm.readableCurrency(1000000, null, "BTC")).toEqual("10 Ƀ");
      expect(wrapper.vm.readableCurrency(10000000, null, "ETH")).toEqual("100 Ξ");
      expect(wrapper.vm.readableCurrency(100000000, null, "LTC")).toEqual(`${Number(1000).toLocaleString()} Ł`);
    });
